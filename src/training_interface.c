...
create_window_training_camp (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (panel_camp), b_dec_recreation, 176, 126);
  gtk_widget_set_size_request (b_dec_recreation, 30, 24);
  ...
  gtk_fixed_put (GTK_FIXED (panel_camp), b_inc_recreation, 425, 126);
  gtk_widget_set_size_request (b_inc_recreation, 30, 24);
  ...
  gtk_fixed_put (GTK_FIXED (panel_camp), b_dec_training, 176, 158);
  gtk_widget_set_size_request (b_dec_training, 30, 24);
  ...
  gtk_fixed_put (GTK_FIXED (panel_camp), b_inc_training, 425, 158);
  gtk_widget_set_size_request (b_inc_training, 30, 24);
