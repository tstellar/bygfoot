...
create_window_training_camp (void)
{
  ...
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (rb_camp3), rb_camp3_group);
  rb_camp3_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (rb_camp3));
  ...
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (rb_camp2), rb_camp3_group);
  rb_camp3_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (rb_camp2));
  ...
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (rb_camp1), rb_camp3_group);
  rb_camp3_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (rb_camp1));
